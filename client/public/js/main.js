...
$('.popup-video').magnificPopup({
  ...
  $.scrollUp({
    ...
    scrollText: '<i className="fa fa-angle-double-up"></i>', // Text for element
...
items:1,
// autoplay:true,
navText:['<i className="Flaticon flaticon-left-arrow"></i>','<i className="Flaticon flaticon-right-arrow"></i>'],
nav:true,
dots:false,
// autoplayHoverPause: true,
// autoplaySpeed: 800,
