...
!(function (e, t, n) {
  ...
  ;(a.prototype.init = function () {
    ...
    if (
      ...
      (a = e('<div className="' + o + '_menu"></div>')),
      '' !== r.brand)
    ) {
      var c = e('<div className="' + o + '_brand">' + r.brand + '</div>')
      e(a).append(c)
    }
    ;(i.btn = e(
      [
        '<' +
          ...
          o +
          '_collapsed">',
        '<span className="' + o + '_menutxt" style="color:white;">' + r.label + '</span>',
        '<span className="' + n + '">',
        '<span className="' + o + '_icon-bar"></span>',
        '<span className="' + o + '_icon-bar"></span>',
        '<span className="' + o + '_icon-bar"></span>',
        '</span>',
        '</' + r.parentTag + '>'
    ...
    e(p).each(function () {
      ...
      if (
        ...
        if (r.allowParentLinks && !r.nestedParentLinks && s)
          e(l)
            .wrapAll('<span className="' + o + '_parent-link ' + o + '_row"/>')
            .parent()
        else {
          var p = e(l)
            .wrapAll(c)
